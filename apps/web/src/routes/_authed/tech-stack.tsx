        ...
        <Section title="If you want to audit X, look at Y">
          <div style={{ background: 'white', border: '1px solid #E2E8F0', borderRadius: '8px', overflow: 'hidden' }}>
            {[
              ...
              { q: 'What the business logic is',                     a: 'apps/api/services/*.py — pricing_service, catalogue_evidence_extraction (OCR), offering_costs, sku_service' },
              ...
              { q: 'How catalogues are ingested (OCR pipeline)',     a: 'apps/api/services/catalogue_evidence_extraction.py (Gemini vision, one call per page) → catalogue_conformance → catalogue_pipeline_stages + apps/web/src/routes/_authed/catalogues/' },
